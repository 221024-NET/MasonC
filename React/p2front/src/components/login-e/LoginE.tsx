...
function LoginP(props: ILoginEmpProps) {
    ...
    let login = async (e: SyntheticEvent) => {
        ...
        if (!email || !password) {
            ...
            try{
                ...
                fetch("https://localhost:7120/employee/LogIn", {
                    method: 'POST',
                    headers: {
                ...
                .then((data) => {
                    ...
                    if (data.email === email){
                        // Navigate to the employee dasgboard here
    ...
    return (
        <>
            <br /><br />
            <h3>Log Into App As An Employee</h3>
            <div id="login-form">
